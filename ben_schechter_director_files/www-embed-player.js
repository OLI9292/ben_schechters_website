...
qc("//web.archive.org/web/20160820145519/https://static.doubleclick.net/instream/ad_status.js",a);Yd.push(Xd(function(){Zd||"google_ad_status"in window||(xc("//web.archive.org/web/20160820145519/https://static.doubleclick.net/instream/ad_status.js",a),$b("DCLKSTAT",3))},5E3))}
...
function $m(a,b){if(2==b||9==b){var c=null;a.P&&(c=null);var d=x(a.qe,a);c||(c=new Lg("//web.archive.org/web/20160820145519/https://www.google.com/images/cleardot.gif"),ah(c));Um(c.toString(),1E4,d)}else Y();Fn(a,b)}
...
a.onError=c;a.Ga=c;Qd("//web.archive.org/web/20160820145519/https://googleads.g.doubleclick.net/pagead/id",a)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();H("PL_ATT")&&(yc=null);for(var a=0,b=Yd.length;a<b;a++){var c=Yd[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):J(c)}}Yd.length=0;a=uc("//web.archive.org/web/20160820145519/https://static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))pc(a),b.parentNode.removeChild(b);Zd=!1;$b("DCLKSTAT",0);mc(Rp);Rp.length=0;wh(Sp);Sp.length=0;Qp=!1;Ro&&(Ro.removeEventListener("SUBSCRIBE",Vo),Ro.removeEventListener("UNSUBSCRIBE",Xo));Ro=null;wh(So);So.length=0;
...
/*
     FILE ARCHIVED ON 14:55:19 Aug 20, 2016 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:16:25 Aug 18, 2018.
...
/*
playback timings (ms):
  LoadShardBlock: 344.995 (3)
  esindex: 0.013
  captures_list: 545.575
  CDXLines.iter: 28.744 (3)
  PetaboxLoader3.datanode: 111.968 (5)
  exclusion.robots: 0.273
  exclusion.robots.policy: 0.257
  RedisCDXSource: 1.191
  PetaboxLoader3.resolve: 480.174 (3)
  load_resource: 371.226
*/